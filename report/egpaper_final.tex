...
\begin{center}
    ...
    \
    \small{Enriched terms for aspect: Molecular Function}
\end{center}

\begin{center}
    \includegraphics[scale=0.30]{report/img/word_cloud_cc.png} \\
    \
    \small{Enriched terms for aspect: Cellular Component}
\end{center}

\begin{center}
    \includegraphics[scale=0.30]{report/img/word_cloud_bp.png} \\
    \
    \small{Enriched terms for aspect: Biological Process}
\end{center} \\
...
There were 18 significant hits in this database. Below, we present the most common one.

\begin{center}
    \includegraphics[scale=1.17]{report/img/Elm.png} \\
    \small{Most common Elm motif in our family}
\end{center}

%The WD40 repeat domain protein WDR5 plays a key role in H3K4 methylation and H4K16 acetylation by acting as a scaffold protein for the assembly of the respective core histone methylation and acetylation complex.
%(this is copied from a section of \href{http://elm.eu.org/elms/LIG_WD40_WDR5_VDV_1.html}{LIG_WD40_WDR5_VDV_1.html}, not really sure how to describe it with my own words) TO FIX: WRONG LINK
...
WDR5 is a protein containing WD40 repeats, which form a beta-propeller structure, crucial for protein-protein interactions. It plays a pivotal role in the regulation of gene transcription, cell cycle progression, and DNA repair through its involvement in post-translational modifications of histones. Specifically, WDR5 plays a key role in H3K4 methylation and H4K16 acetylation by acting as a scaffold protein for the assembly of the respective core histone methylation and acetylation complex. The WDR5-binding motif, as described by the ELM database (accession \texttt{ELME000365}), is a functional site that interacts with WDR5 between blades 5 and 6 of the WD40 repeat. The WDR5-binding motif is conserved across various species, indicating its importance in biological processes. \\
...
The other 3 hits were: 
\begin{itemize}
\item \textit{PS00001}: A N-glycosylation site
\item \textit{PS00005}: A protein kinase C phosphorylation site
\item \textit{PS00006} A casein kinase II phophorylation site
\end{itemize}
...
\subsection{ProSite}
\begin{center}
    \includegraphics[scale=0.88]{report/img/Prosite.png} \\
